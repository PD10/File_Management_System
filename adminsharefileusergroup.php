...
<form action = "adminsharefileusergroup.php" method = "post">
    <div id="tableContainer-1">
		    ...
		    <table id="myTable" class="form" border="1">
		                  <tbody>
		                    <tr>
		                      <p>
								 <td>
									<label for="adminfilesharetousergroupfilename" align = "center">File Name: </label>
									<select id="adminfilesharetousergroupfilename" name="adminfilesharetousergroupfilename" required="required">
										<option>...</option>
										<?php 
		    ...
		    <table id="myTable" class="form" border="1">
		                  <tbody>
		                    <tr>
		                      <p>
								 <td>
									<label for="adminfilesharetousergroupgroupname" align = "center">User Group Name: </label>
									<select id="adminfilesharetousergroupgroupname" name="adminfilesharetousergroupgroupname" required="required">
										<option>...</option>
										<?php 
		...
		<div class = "input-group">
        	<button type = "submit" name = "adminsharefiletousergroup" class = "btn" onclick = "sharefile()">Share File</button>
      	</div>
    </form>
