...
<div class = "header">
	<h2>Share Files To Users</h2>
</div>
<form action = "usersharefileusers.php" method = "post">
    <div id="tableContainer-1">
		    ...
		    <table id="myTable" class="form" border="1">
		                  <tbody>
		                    <tr>
		                      <p>
								 <td>
									<label for="userfilesharetouserfilename" align = "center">File Name: </label>
									<select id="userfilesharetouserfilename" name="userfilesharetouserfilename" required="required">
										<option>...</option>
										<?php 
		    ...
		    <table id="myTable" class="form" border="1">
		                  <tbody>
		                    <tr>
		                      <p>
								 <td>
									<label for="userfilesharetouserusername" align = "center">Username: </label>
									<select id="userfilesharetouserusername" name="userfilesharetouserusername" required="required">
										<option>...</option>
										<?php 
											$res1 = mysqli_query($db,"SELECT * FROM users WHERE USERNAME != 'admin' AND USERNAME != '{$_SESSION['username']}'");
		...
		<div class = "input-group">
        	<button type = "submit" name = "usersharefiletouser" class = "btn" onclick = "sharefile()">Share File</button>
      	</div>
    </form>
