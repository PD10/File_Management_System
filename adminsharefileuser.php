...
<form action = "adminsharefileuser.php" method = "post">
    <div id="tableContainer-1">
		    ...
		    <table id="myTable" class="form" border="1">
		                  <tbody>
		                    <tr>
		                      <p>
								 <td>
									<label for="adminfilesharetouserfilename" align = "center">File Name: </label>
									<select id="adminfilesharetouserfilename" name="adminfilesharetouserfilename" required="required">
										<option>...</option>
										<?php 
		    ...
		    <table id="myTable" class="form" border="1">
		                  <tbody>
		                    <tr>
		                      <p>
								 <td>
									<label for="adminfilesharetouserusername" align = "center">User Name: </label>
									<select id="adminfilesharetouserusername" name="adminfilesharetouserusername" required="required">
										<option>...</option>
										<?php 
											$res1 = mysqli_query($db,"SELECT * FROM users WHERE USERNAME != 'admin'");
		...
		<div class = "input-group">
        	<button type = "submit" name = "adminsharefiletouser" class = "btn" onclick = "sharefile()">Share File</button>
      	</div>
    </form>
