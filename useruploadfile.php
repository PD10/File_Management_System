  ...
  <a class="w3-bar-item w3-button w3-hover-black" href="usermyfiles.php">My Files</a>
	...
	<form action = "useruploadfile.php" method = "post" enctype = "multipart/form-data">
		<div class = "input-group">
      		...
      		<input id = "userfile" name = "userfilename" type = "file">
      	</div>
      	<div class = "input-group">
      		<label>Description About File:</label>
      		<input id = "userfiledesc" name = "userfiledesc" type = "text" placeholder = "WRITE SOMETHING ABOUT THE FILE">
      	</div>
		<div class = "input-group">
        	<button type = "submit" name = "useruploadfile" class = "btn" onclick = "userfileupload()">Upload File</button>
      	</div>
    </form>
