...
<!-- END MAIN -->
	...
	<form action = "adminuploadfile.php" method = "post" enctype = "multipart/form-data">
		<div class = "input-group">
      		<label>Please Select File:</label>
      		<input id = "adminfile" name = "adminfilename" type = "file">
      	</div>
      	<div class = "input-group">
      		<label>Description About File:</label>
      		<input id = "adminfiledesc" name = "adminfiledesc" type = "text" placeholder = "WRITE SOMETHING ABOUT THE FILE">
      	</div>
		<div class = "input-group">
        	<button type = "submit" name = "adminuploadfile" class = "btn" onclick = "alertfileuploaded()"">Upload File</button>
      	</div>
    </form>
